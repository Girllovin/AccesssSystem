package smallITgroup.door.dao.exeptions;

import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.ResponseStatus;

//@ResponseStatus annotation indicates the HTTP status to be returned when this exception is thrown.
// In this case, it's a 404 Not Found status, indicating that the resource (door) could not be found.
...
public class DoorNotFoundExeption extends RuntimeException{
	...
	private static final long serialVersionUID = 2186970798370778069L;
