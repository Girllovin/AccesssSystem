...
public interface EventService {
    ...
    Map<String, EventDto> getNewEvents();
    
    // Retrieves events related to a specific door, identified by its doorId
    Map<String, EventDto> getDoorActivityById(String doorId);
    
    // Retrieves historical events based on a specific date
    Map<String, EventDto> getHistoryByDay(LocalDate date);
	...
	Map<String, EventDto> getAllEvents();
}
